...
//                    Class.forName("com.mysql.cj.jdbc.Driver");
//            java.sql.Connection con = (java.sql.Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/fees_mange_sys","root","Chirag@123");
//             String sqlcon = "select max(id) from feesss";
      ...
      String initialamount = (txt_amount.getText());
       ...
       String rollno =(txt_rollno.getText());
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
            java.sql.Connection con = (java.sql.Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/fees_mange_sys","root","Chirag@123");
            PreparedStatement pst = con.prepareStatement("insert into feess values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
           // pst.setInt(1,getId());
        ...
        pst.setString(5, initialamount);
         pst.setFloat(6, totalAmount);
         pst.setString(7,totalinwords);
        pst.setString(8, paymentmode);
        pst.setString(9, chequeno); 
        pst.setString(10, bankName);
         pst.setString(11, ddNO); 
         pst.setString(12, gstint);
         pst.setFloat(13, cgst); 
        pst.setFloat(14, sgst);
         pst.setString(15, courseName);
...
//         
    ...
    private void initComponents() {
        ...
        homepanel.add(homelabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 210, 50));
        ...
        backpanel.add(homelabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 210, 70));
